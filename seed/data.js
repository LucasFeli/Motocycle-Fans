module.exports = [
    ...
    description: "Este 2020 la firma de los diapasones no se ha andado con medias tintas y presenta al Yamaha TMAX 560, el TMAX más potente de la historia, además de una estética más agresiva a juego con un comportamiento dinámico aún más afilado.",
},
{
    marca: "Suzuki A 50 P/D",
    modelo : 1979,
    motor: "Dos tiempos, válvula de piston, monocilindrico ",
    image:"http://suprememotos.com/uploads/postfotos/suzuki-a50p-ap50-blue-uk-model-sixteener-special-sports-moped-1.JPG",
    description: "La nueva Suzuki era una máquina profesional para mirar con una gran postura y actitud de moto. La usabilidad también fue una delicia con un sistema de autolubricación mucho antes de su tiempo, la bomba fue impulsada por el engranaje inactivo de arranque que a su vez tomó su impulso desde el eje de salida de la caja de engranajes, esto resultó en el eje de arranque no funciona cuando se aprieta el embrague, pero es un pequeño precio a pagar por la facilidad que se encuentra en el momento del llenado. ",
},
{
    marca: "KTM 300 EXC TPI ERZBERGRODEO ",
    modelo : 2021,
    motor: "Dos tiempos, 300cc ",
